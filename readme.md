...
1. Змінити на сервері у папці `config` адреси хостів у кофігураційному файлі Postgres з `db-dev` на `localhost`.
...
- Завдання 7 не відображатиме результати через повний перехід на іншу БД.
...
Проте файли докера налаштовані для можливого використання.
